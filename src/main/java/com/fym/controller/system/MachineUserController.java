...
@Controller
@RequestMapping("/system/machine_user")
public class MachineUserController extends BaseController{
    ...
    @ResponseBody
    public Object edit(){
        serverService.editServers(getOper(), OperObject.OPER_MACHINE_USER);
        return true;
    }
}
